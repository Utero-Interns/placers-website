...
/* 🔥 FIX: normalize LatLng / LatLngLiteral */
      ...
      new MarkerClusterer({
        ...
        renderer: {
          render: (cluster: Cluster) => {
            const positionLiteral = toLatLngLiteral(cluster.position);
                ...
                url:
                  ...
                  encodeURIComponent(`
                    <svg width="44" height="44" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <text x="22" y="27" text-anchor="middle" font-size="14" font-weight="600" fill="white" font-family="Poppins, Arial, sans-serif">
                        ${cluster.count}
                      </text>
                    </svg>
                  `),
